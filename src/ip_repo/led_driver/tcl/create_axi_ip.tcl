...
#	set IPCORE [lindex $argv 3]
	set COMPANY_NAME [lindex $argv 3]
...
create_peripheral hws.aisec.fraunhofer.de $COMPANY_NAME $IP_NAME 1.0 -dir ./ip_repo
add_peripheral_interface S00_AXI -interface_mode slave -axi_type lite [ipx::find_open_core hws.aisec.fraunhofer.de:$COMPANY_NAME:$IP_NAME:1.0]
set_property VALUE 4 [ipx::get_bus_parameters WIZ_NUM_REG -of_objects [ipx::get_bus_interfaces S00_AXI -of_objects [ipx::find_open_core hws.aisec.fraunhofer.de:$COMPANY_NAME:$IP_NAME:1.0]]]

generate_peripheral -driver -bfm_example_design -debug_hw_example_design [ipx::find_open_core hws.aisec.fraunhofer.de:$COMPANY_NAME:$IP_NAME:1.0]
